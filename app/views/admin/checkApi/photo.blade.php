...
<script>
	...
	function getUser(access_token, service_app, version) {
        $.ajax({
	...
	function createSession(access_token, service_app, version) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('#tag_photo').html('Photo waiting...');
                $('#tag_message').html('Message waiting...');
            },
            success:function(result) {
                console.log(result);
    ...
    function postPhoto(access_token, service_app, session_id, version) {
        ...
        $.ajax({
            ...
            success:function(result) {
                ...
                postMessage(access_token, service_app, session_id, version);
            },
            error: function(jqXHR){
